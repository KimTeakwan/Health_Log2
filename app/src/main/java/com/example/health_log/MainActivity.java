...
public class MainActivity extends AppCompatActivity {
    ...
    private String currentSortBy = "latest"; // Default sort order
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getVideos(currentQuery, currentSortBy); // Load all videos initially with default sort

        // Category Tabs
        TabLayout categoryTabLayout = findViewById(R.id.tabs);
        categoryTabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (getString(R.string.tab_home).equalsIgnoreCase(selectedTag)) {
                    ...
                    currentQuery = selectedTag; // Use selected tag as query
                }
            ...
            public void onTabReselected(TabLayout.Tab tab) {
                // Refresh content for the re-selected tab
                getVideos(currentQuery, currentSortBy);
            }
        });
        ...
        // Filter Tabs
        TabLayout filterTabLayout = findViewById(R.id.filter_tabs);
        filterTabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            @Override
            public void onTabSelected(TabLayout.Tab tab) {
                String selectedFilter = tab.getText().toString();
                if (getString(R.string.filter_latest).equalsIgnoreCase(selectedFilter)) {
                    currentSortBy = "latest";
                } else if (getString(R.string.filter_popular).equalsIgnoreCase(selectedFilter)) {
                    currentSortBy = "popular";
                } else if (getString(R.string.filter_most_adopted).equalsIgnoreCase(selectedFilter)) {
                    currentSortBy = "adopted";
                }
                getVideos(currentQuery, currentSortBy);
            }
    ...
    private void getVideos(String query, String sortBy) {
        apiService.getVideos(query, sortBy).enqueue(new Callback<List<Video>>() {
            @Override
